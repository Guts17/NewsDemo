...
import com.lsq.newsdemo.ImagesActivity;
...
public class MyScrollView extends ScrollView implements OnTouchListener {
	...
	public MyScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		Images.imgArrayList = HtmlImages.getImages(Images.url);
		System.out.println("222222" + HtmlImages.getImages(Images.url).toString());
		System.out.println("MyScrollView执行");
	...
	public void loadMoreImages() {
		...
		System.out.println("loadMoreImages执行");
		if (hasSDCard()) {
